...
export function CountryNews(props) {
    ...
    return (
        <>
        <h1 className='text-4xl font-bold text-[#babde2] mt-24 p-5 text-center mb-5'>Market Pulse: What's Happening in {" "}
            { isoCountries[params.iso.toUpperCase()]}</h1>
            <div className='grid grid-cols-4 gap-8 mt-5 p-12'>
